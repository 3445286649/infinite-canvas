...
export type AiConfig = {
    ...
    videoMode: string;
    videoPinFirst: string;
    videoPinLast: string;
    videoKeyframeTimes: string;
    videoVoiceIds: string;
    systemPrompt: string;
            ...
            merge: (persisted, current) => {
                ...
                return {
                    ...
                    config: {
                        ...
                        videoMode: ["frames", "reference", "edit", "extend"].includes(config.videoMode) ? config.videoMode : "frames",
                        videoPinFirst: config.videoPinFirst || "false",
                        videoPinLast: config.videoPinLast || "false",
