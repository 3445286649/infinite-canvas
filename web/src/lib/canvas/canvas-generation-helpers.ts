...
export function buildGenerationConfig(config: AiConfig, node: CanvasNodeData | undefined, mode: CanvasNodeGenerationMode): AiConfig {
    return {
        ...
        videoPinFirst: node?.metadata?.videoPinFirst ?? config.videoPinFirst,
        videoPinLast: node?.metadata?.videoPinLast ?? config.videoPinLast,
        videoKeyframeTimes: node?.metadata?.videoKeyframeTimes ?? config.videoKeyframeTimes,
        videoVoiceIds: node?.metadata?.videoVoiceIds ?? config.videoVoiceIds,
